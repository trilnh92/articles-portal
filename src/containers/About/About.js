...
class About extends Component {
    componentDidMount() {
        document.title = "About | Articles Portal";
    }
            ...
            <section className="about">
                <div className="about__container">
                    <div className="about__heading">
                        <h1 className="about__heading-title"> About.
                        </h1>
                    </div>
                </div>
                <div className="about__image">
                    <ArticleImage imgSource="https://images.unsplash.com/photo-1543618415-aa9fea0b0b02?q=10" alt="about-articles-portal"/>
                </div>
                <div className="about__container">
                    <div className="about__content">
                        ...
                        <p>In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum
                            felis eu pede mollis pretium. Integer tincidunt. Cras dapibus.</p>
                        ...
                        <p>Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a
                        ...
                        <p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In ac
                            dui quis mi consectetuer lacinia. Nam pretium turpis et arcu. Duis arcu tortor, suscipit
                            eget, imperdiet nec, imperdiet iaculis, ipsum. Sed aliquam ultrices mauris. Integer ante
                            arcu, accumsan a, consectetuer eget, posuere ut, mauris. Praesent adipiscing. Phasellus
